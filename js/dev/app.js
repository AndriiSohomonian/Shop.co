...
class ConstructionOfTheCard {
  ...
  get Price() {
    ...
    if (this.price.sale === 0) cardPrice.textContent = "$" + this.price.startPrice;
    else {
      cardPrice.textContent = "$" + Math.ceil(this.price.startPrice - this.price.startPrice * this.price.sale / 100);
